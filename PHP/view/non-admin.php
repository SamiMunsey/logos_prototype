...
<div class="sidenav">
  <button class="dropdown-btn">Non-admin User <img src="media/profile-logo.png" id="homelogo"
  ...
  <hr>
  <a href="non-admin.php">Home</a>
  <hr>
  <h2 style="margin-left: 20px;">Browse</h2>

  <button class="dropdown-btn">Non-fiction <img src="media/Arrow-down.svg.png" id="downarrow">
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
...
<?php include "../model/dropdown_script.php" ?>
    ...
    <div class="searchcontainer">
        <form>
            <img src="media/mag.svg.png" id="homelogo"><input type="search" class="large-search-box" value="Search the library">
        </form>
    </div>
