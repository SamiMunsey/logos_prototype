<?php 
    include "../model/resource/read.php"; 
...
<div class="new-button">
    <a href="forms/resource_record.php"><button id="new-resource-button">Create new resource record</button></a>
</div>
    ...
    <div class="searchresults">
        ...
        <table style="width: 100%">
            ...
            <tr style="text-align: center">                    
                ...
                <td><a href="forms/resource_record.php?id=<?= htmlentities($resource['id']) ?>" role=button>Edit</a></td>
                <td><a href="../model/resource/delete.php?id=<?= htmlentities($resource['id']) ?>" role=button>Delete</a></td>
            </tr>
            <?php endforeach; ?>
        </table>
        <br/>
