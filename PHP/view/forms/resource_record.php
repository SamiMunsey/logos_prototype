<?php 
    ...
    include "../../model/resource/check-create_or_update.php";
...
<form method='post' action='../../model/resource/create_update.php'>
<!--<form method='post' action='dao-add-edit.php'>-->
...
<table class="record-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="create_genre.php">create new genre</a>
                    <div class="tooltip"><img src="../media/help.png" id="helpicon">
